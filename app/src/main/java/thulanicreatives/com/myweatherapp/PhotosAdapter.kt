...
import thulanicreatives.com.myweatherapp.databinding.ItemRowPhotosBinding
...
open class PhotosAdapter :
    ...
    private lateinit var binding: ItemRowPhotosBinding
    ...
    inner class DataViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(result: Photos) {
            binding.name.text = result.id +" "+ result.author
            Glide.with(binding.imageView.context).load(result.downloadUrl).into(binding.imageView)
